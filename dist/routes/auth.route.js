...
router.get('/guest', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return User.findOne({
              where: {
                email: _config["default"].GUEST_USER
              }
            });
          ...
          case 2:
            user = _context.sent;
            _context.next = 5;
            return user.generateGuestAuthToken();
...
router.post('/login', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body, email, password, user, userResult, token, logActivity;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 10:
            ...
            logActivity.activityType = _enumConstants.ACTIVITY_TYPE.USER_LOGIN;

            _logActivityService["default"].saveLogActivity(logActivity);
...
router.get('/logout', _auth["default"], /*#__PURE__*/function () {
...
router.post('/logoutall', _auth["default"], /*#__PURE__*/function () {
