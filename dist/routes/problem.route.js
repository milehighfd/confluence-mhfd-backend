...
router.get('/get-name', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var problem_id, sql, URL;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            try {
              ...
              sql = "SELECT problem_name FROM ".concat(_config.PROBLEM_TABLE, " WHERE problem_id = ").concat(problem_id);
              ...
              _https["default"].get(URL, function (response) {
                ...
                if (response.statusCode === 200) {
                  ...
                  response.on('end', function () {
                    ...
                    var problemname = result.length ? result[0].problem_name : '-';
...
router.post('/filters', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var filters, where, sql, key, URL;
        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            try {
              filters = req.body;
              where = '';
              sql = "select * from ".concat(_config.PROBLEM_TABLE, " ");
              ...
              if (filters) {
                ...
                for (key in filters) {
                  if (key === 'problemname' && filters[key] != null) {
                    where += "".concat(key, " = '").concat(filters[key], "' ");
                  }
                }
