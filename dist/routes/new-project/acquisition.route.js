...
router.post('/', [_auth["default"], multer.array('files')], /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var user, _req$body, isWorkPlan, projectname, description, servicearea, county, geom, acquisitionprogress, acquisitionanticipateddate, locality, jurisdiction, sponsor, cosponsor, cover, year, sendToWR, status, projecttype, notRequiredFields, notRequiredValues, result, splittedJurisdiction, _iterator, _step, j, insertQuery, query, _result, data, projectId, updateId;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (acquisitionprogress) {
              ...
              notRequiredValues += "'".concat(acquisitionprogress, "'");
            }
            ...
            if (acquisitionanticipateddate) {
              ...
              notRequiredValues += "".concat(acquisitionanticipateddate);
            }
            ...
            if (cosponsor) {
              ...
              notRequiredValues += "'".concat(cosponsor, "'");
            }
          ...
          case 16:
            ...
            j = _step.value;
            insertQuery = "INSERT INTO ".concat(_config.CREATE_PROJECT_TABLE, " (the_geom, jurisdiction, projectname, description, servicearea, county, status, projecttype, sponsor ").concat(notRequiredFields, "  ,projectid)\n    VALUES(ST_GeomFromGeoJSON('").concat(geom, "'), '").concat(j, "', '").concat((0, _helper.cleanStringValue)(projectname), "', '").concat((0, _helper.cleanStringValue)(description), "', '").concat(servicearea, "', '").concat(county, "', '").concat(status, "', '").concat(projecttype, "', '").concat(sponsor, "' ").concat(notRequiredValues, " ,").concat(-1, ")");
            query = {
              q: insertQuery
            };

            _logger["default"].info('my query ' + query.q);
          ...
          case 25:
            ...
            _logger["default"].info(JSON.stringify(_result));
    ...
    }, _callee, null, [[14, 56, 59, 62], [22, 47]]);
  }));
...
router.post('/:projectid', [_auth["default"], multer.array('files')], /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var user, projectid, _req$body2, projectname, description, servicearea, county, geom, acquisitionprogress, acquisitionanticipateddate, locality, jurisdiction, sponsor, cosponsor, cover, sendToWR, projecttype, notRequiredFields, updateQuery, query, result, data;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _req$body2 = req.body, projectname = _req$body2.projectname, description = _req$body2.description, servicearea = _req$body2.servicearea, county = _req$body2.county, geom = _req$body2.geom, acquisitionprogress = _req$body2.acquisitionprogress, acquisitionanticipateddate = _req$body2.acquisitionanticipateddate, locality = _req$body2.locality, jurisdiction = _req$body2.jurisdiction, sponsor = _req$body2.sponsor, cosponsor = _req$body2.cosponsor, cover = _req$body2.cover, sendToWR = _req$body2.sendToWR;
            projecttype = 'Acquisition';
            notRequiredFields = "";
            ...
            if (acquisitionprogress) {
              ...
              notRequiredFields += "acquisitionprogress = '".concat(acquisitionprogress, "'");
            }
            ...
            if (acquisitionanticipateddate) {
              ...
              notRequiredFields += "acquisitionanticipateddate = ".concat(acquisitionanticipateddate);
            }
