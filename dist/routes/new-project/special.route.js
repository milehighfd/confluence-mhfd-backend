...
router.post('/', [_auth["default"], multer.array('files')], /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var user, _req$body, projectname, description, servicearea, county, geom, locality, jurisdiction, sponsor, cosponsor, cover, year, sendToWR, status, projecttype, notRequiredFields, notRequiredValues, result, splittedJurisdiction, _iterator, _step, j, insertQuery, query, _result, data, projectId, updateId;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            user = req.user;
            _req$body = req.body, projectname = _req$body.projectname, description = _req$body.description, servicearea = _req$body.servicearea, county = _req$body.county, geom = _req$body.geom, locality = _req$body.locality, jurisdiction = _req$body.jurisdiction, sponsor = _req$body.sponsor, cosponsor = _req$body.cosponsor, cover = _req$body.cover, year = _req$body.year, sendToWR = _req$body.sendToWR;
            status = 'Draft';
            projecttype = 'Special';
            notRequiredFields = '';
            notRequiredValues = '';
          ...
          case 14:
            ...
            j = _step.value;
            insertQuery = "INSERT INTO ".concat(_config.CREATE_PROJECT_TABLE, " (the_geom, jurisdiction, projectname, description, servicearea, county, status, projecttype, sponsor ").concat(notRequiredFields, " ,projectid) \n    VALUES(ST_GeomFromGeoJSON('").concat(geom, "'), '").concat(j, "', '").concat((0, _helper.cleanStringValue)(projectname), "', '").concat((0, _helper.cleanStringValue)(description), "', '").concat(servicearea, "', '").concat(county, "', '").concat(status, "', '").concat(projecttype, "', '").concat(sponsor, "' ").concat(notRequiredValues, " , -1)");
            query = {
              q: insertQuery
            };
          ...
          case 35:
            _context.next = 37;
            return (0, _helper.addProjectToBoard)(user, servicearea, county, jurisdiction, projecttype, projectId, year, sendToWR);
    ...
    }, _callee, null, [[12, 54, 57, 60], [20, 45]]);
  }));
...
router.post('/:projectid', [_auth["default"], multer.array('files')], /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var user, projectid, _req$body2, projectname, description, servicearea, county, geom, locality, jurisdiction, sponsor, cosponsor, sendToWR, cover, projecttype, notRequiredFields, updateQuery, query, result, data;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _req$body2 = req.body, projectname = _req$body2.projectname, description = _req$body2.description, servicearea = _req$body2.servicearea, county = _req$body2.county, geom = _req$body2.geom, locality = _req$body2.locality, jurisdiction = _req$body2.jurisdiction, sponsor = _req$body2.sponsor, cosponsor = _req$body2.cosponsor, sendToWR = _req$body2.sendToWR, cover = _req$body2.cover;
            projecttype = 'Special';
            notRequiredFields = '';
