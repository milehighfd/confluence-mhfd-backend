...
var Op = _sequelize["default"].Op,
    literal = _sequelize["default"].literal;

var router = _express["default"].Router();

var User = _db["default"].user;

var UPDATEABLE_FIELDS = _userService["default"].requiredFields('edit');

router.put('/change-user-state/:id/:status', [_auth["default"], _utils.isAdminAccount], /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 11:
            if (user.activated) {
              _userService["default"].sendApprovedAccount(user);
            }
...
router.put('/edit-user/:id', [_auth["default"], _utils.isAdminAccount], /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, next) {
    var id, user, count, _iterator, _step, field;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 13:
            if (_enumConstants.EMAIL_VALIDATOR.test(req.body.email)) {
              _context2.next = 15;
              break;
            }
          ...
          case 15:
            _iterator = _createForOfIteratorHelper(UPDATEABLE_FIELDS);
...
router["delete"]('/delete-user/:id', [_auth["default"], _utils.isAdminAccount], /*#__PURE__*/function () {
...
router.get('/list', [_auth["default"], _utils.isAdminAccount], /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res, next) {
    var organization, serviceArea, designation, search_obj, status, limit, page, name, sort, sortObject, userCount, sortField, userList, numberOfPages;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            search_obj = {}; // activated: !isPending

            status = req.query.status; //console.log('status', status);

            limit = +req.query.limit || _config.NUMBER_PER_PAGE;
            page = +req.query.page || _config.INITIAL_PAGE;
            name = req.query.name;
            ...
            if (name) {
              search_obj[Op.or] = {
                firstName: _defineProperty({}, Op.like, '%' + name + '%'),
                lastName: _defineProperty({}, Op.like, '%' + name + '%')
              };
            }
          ...
          case 25:
            ...
            numberOfPages = Math.ceil(userCount / limit);
