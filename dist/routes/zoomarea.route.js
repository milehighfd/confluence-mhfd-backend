        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            newProm = new Promise(function (resolve, reject) {
              var sql = "select cartodb_id, aoi, filter, ST_AsGeoJSON(ST_Envelope(the_geom)) from mhfd_zoom_to_areas order by aoi";
              var URL = encodeURI("".concat(_config.CARTO_URL, "&q=").concat(sql));
              var result = [];
              ...
              _https["default"].get(URL, function (response) {
                if (response.statusCode === 200) {
                  ...
                  response.on('end', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
                    var firstElement, arrayAux, _iterator, _step, row, result;
                      ...
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            firstElement = {};
                            arrayAux = [];
                            _iterator = _createForOfIteratorHelper(JSON.parse(str).rows);
...
router.get('/complete', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            newProm = new Promise(function (resolve, reject) {
              var sql = "select cartodb_id, aoi, filter, ST_AsGeoJSON(the_geom) from mhfd_zoom_to_areas order by aoi";
              var URL = encodeURI("".concat(_config.CARTO_URL, "&q=").concat(sql));
              var result = [];
              ...
              _https["default"].get(URL, function (response) {
                if (response.statusCode === 200) {
                  ...
                  response.on('end', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
                    var firstElement, arrayAux, _iterator2, _step2, row, result;
                      ...
                      while (1) {
                        switch (_context3.prev = _context3.next) {
                          case 0:
                            firstElement = {};
                            arrayAux = [];
                            _iterator2 = _createForOfIteratorHelper(JSON.parse(str).rows);
...
router.get('/get-zoom-filter', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.prev = 0;
            newProm = new Promise(function (resolve, reject) {
              var sql = "select filter, aoi from mhfd_zoom_to_areas group by filter, aoi order by filter, aoi";
              var URL = encodeURI("".concat(_config.CARTO_URL, "&q=").concat(sql));
              var result = [];
              ...
              _https["default"].get(URL, function (response) {
                if (response.statusCode === 200) {
                  ...
                  response.on('end', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
                    var data, result, group, elementGroup, _iterator3, _step3, row;
