...
db.user.belongsTo(db.businessAssociateContact,{foreignKey: 'business_associate_contact_id',sourceKey: "business_associate_contact_id" });
...
db.project.hasOne(db.projectServiceArea, {foreignKey: 'project_id', as: 'sortServiceArea'});
...
db.projectPartner.belongsTo(
  db.projectCost,
   { foreignKey: 'project_partner_id' }
);
db.projectCost.hasMany(db.projectPartner, {foreignKey: 'project_partner_id'});
