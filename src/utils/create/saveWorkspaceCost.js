...
import { insertFromPositionOfColumn } from 'bc/routes/board-project/updateSortOrderFunctions.js';
...
export const saveWorkspaceCostInit = async (project_id, board_project_id, code_cost_type_id, project_partner_id, creator, boardId, transaction) => { 
  try {
    ...
    insertFromPositionOfColumn(boardId, currentColumn, movePosition, transaction);
