...
export const saveEstimatedCost = async (project_id, estimatedCost, creator, estimatedcostDescription, sourceFromSystem, transaction) => {
  try {
    ...
    const CODE_DATA_SOURCE_TYPE = sourceFromSystem ? 7: 1;
    console.log('saveEstimatedCost', project_id, estimatedCost, sourceFromSystem, CODE_DATA_SOURCE_TYPE);
    ...
    if (hasChanged) {
      ...
      const newProjectCostData = {
        ...
        cost_description: estimatedcostDescription,
        code_data_source_type_id: CODE_DATA_SOURCE_TYPE
      };
